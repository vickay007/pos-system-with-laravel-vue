	                ...
	                <div class="login-form">
	                  ...
	                  <form class="user" @submit.prevent="customerUpdate" enctype="multipart/form-data">
	                  	<div class="row">
		                    ...
		                    <div class="col-md-6">
		                  		<div class="form-group">
		                  			<label for="exampleFormControlTextarea1">Customer Email</label>
	                  	...
	                  	<div class="row">
	                  		<div class="col-md-6">
			                      ...
			                      <input type="text" class="form-control" id="exampleInputFirstName" v-model="form.address">
		                  	...
		                  	<div class="col-md-6">
		                  		<div class="form-group">
		                  		  <label for="exampleFormControlTextarea1">Customer Phone Number</label>
