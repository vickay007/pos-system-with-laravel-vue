	                  ...
	                  <form class="user" @submit.prevent="updateSalary">
	                  	<div class="row">
	                  		<div class="col-md-6">
			                      ...
			                      <input type="text" class="form-control" id="exampleInputFirstName" v-model="form.name" readonly>
		                    ...
		                    <div class="col-md-6">
			                      ...
			                      <input type="email" class="form-control" id="exampleInputFirstName" v-model="form.email" readonly>
